...
?>
    <tr>
        ...
        <td>
            ...
            <button type="button" value="<?= $employee->id ?>" class="btn btn-success employee-edit-btn">
            ...
            <button type="button" value="<?= $employee->id ?>" class="btn btn-danger employee-delete-btn">
